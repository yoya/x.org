...
static struct key_geometry ncd101_geom_row0 [] = {
 {7, 7}, {7, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {4, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {4, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {4, 0},
...
static struct key_geometry ncd101_geom_row2 [] = {
...
static struct key_geometry ncd101_geom_row3 [] = {
...
static struct key_geometry ncd101_geom_row4 [] = {
 {13, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7},
 {7, 7}, {7, 7}, {7, 7}, {16, 7}, {29, 0},
 {7, 7}, {7, 7}, {7, 7}
};

static struct key_geometry ncd101_geom_row5 [] = {
...
static struct key_geometry ncd101_geom_row6 [] = {
 {11, 7}, {7, 0},
 {11, 7}, {48, 7}, {11, 7}, {7, 0},
 {11, 7}, {4, 0},
 {7, 7}, {7, 7}, {7, 7}, {4, 0},
...
static struct keyboard_row_geometry ncd101_geom_rows [] = {
...
static struct keyboard_geometry ncd101_geom = {
