...
#define F_PANNER		52
#define F_SCROLLBACK		53
#define F_RELATIVERESIZE	54
...
#define F_MENUFUNC		113	/* string */
#define F_WINEXEC		114	/* string */
#define F_TESTWINEXEC		115	/* string */
#define F_RELATIVEMOVE		116	/* direction and integer */
