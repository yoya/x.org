...
typedef struct _TwmPixmap {
    char *name;				/* name of pixmap file */
    Pixmap bm;				/* bitmap form */
...
{
    char *Identification;	/* human-readable name of the tvtwm instance */
    ...
    TwmPixmap Unknown;		/* the unknown icon pixmap */
    Pixmap rootWeave;		/* root weave pixmap */

    TwmPixmap hilite;		/* focus highlight window background */
    TwmPixmap hiliteLeft;	/* focus highlight window left end */
    TwmPixmap hiliteRight;	/* focus highlight window right end */
    TwmPixmap iconifyPm;	/* the icon manager iconify pixmap */
    TwmPixmap pullrightPm;	/* pull right menu arrow */
    TwmPixmap shadowPm;		/* menu shadow pixmap */
    ...
    name_list *SqueezeIconL;		/* windows of which to squeeze icon */
    name_list *DontSqueezeIconL;	/* windows of which not to squeeze */
    ...
    Font   cursorFont;		/* the cursor-glyph font */
    ...
    name_list *IconRegions;	/* match list of icon regions */
    ...
    short OpaqueMoveSaveUnders;	/* turn on save unders when opaque moving */
    ...
    short PopupSensitivity;	/* percantage of a menu's width causing popup */
    ...
    short SqueezeIcon;		/* Shape the icon and label */
    ...
    short RememberScreenPosition; /* when deiconifying, put it back where
				it was relative to the screen, rather
				than relative to the virtual root */
    ...
    short DontInterpolateTitles;	/* interpolatecolor apply to titles? */
