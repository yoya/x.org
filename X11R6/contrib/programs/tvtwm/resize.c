 ...
 *
 * $Log: resize.c,v $
 * Revision 1.5  1992/11/04  01:17:22  cross
 * Added code from rjc, with filtering.
 * See text in CHANGES for details.
 *
 * Revision 1.4  1992/08/27  15:36:04  cross
 * Hmm, who's change is this?  Well, It'll stay for now
 *
 * Revision 1.3  1991/10/29  22:28:11  cross
