/*
 *	$Source: /usr/expo/X/src/clients/xcalc/RCS/sr.c,v $
 *	$Header: sr.c,v 1.8 88/02/07 16:29:59 jim Exp $
 */

#ifndef lint
static char *rcsid_sr_c = "$Header: sr.c,v 1.8 88/02/07 16:29:59 jim Exp $";
#endif	lint
