/*
 *	$Source: /usr/expo/X/src/clients/xcalc/RCS/xcalc.c,v $
 *	$Header: xcalc.c,v 1.15 88/02/27 10:19:24 jim Exp $
 */

#ifndef lint
static char *rcsid_xcalc_c = "$Header: xcalc.c,v 1.15 88/02/27 10:19:24 jim Exp $";
#endif	lint
