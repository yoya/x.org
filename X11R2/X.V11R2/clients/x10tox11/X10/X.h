...
/* $Header: X.h,v 4.0 88/01/27 16:58:09 toddb Exp $ */
...
/*
 * Tektronix address space.
 */
#define XDEV_TEK 		1200    /* Tektronix base address */
#define	XDEV_TEK4315		1201	/* Tek pegasus 4405+ or 4315 */
#define	XDEV_TEK4406		1202	/* Tek pegasus 4406+ */
#define	XDEV_TEK4316		1203	/* Tek pegasus 4316 */
#define	XDEV_TEK4317		1204	/* Tek pegasus 4317 */
#define XDEV_TEK432x		1210	/* Tek GDS 4324 and 4325 */
#define XDEV_TEK433x		1211	/* Tek GDS 4335, 4336 and 4337 */
...
#define XYPixmapSize(width, height, planes) ((((width)+15 >> 3) & ~1) * (height) * UBPS * (planes))
