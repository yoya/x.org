char rcsid[] =
	"$Header: /usr/src/unsup/bin/patch/RCS/patch.c,v 2.8 87/02/17 13:57:47 doc Exp $";
 ...
 *
 * $Log:	patch.c,v $
 * Revision 2.8  87/02/17  13:57:47  doc
 * Applied patch #8 from net.
 * 
 * Revision 2.7  87/02/04  11:05:43  ksb
 * patched to revision 2.7
 * 
 * Revision 2.2  86/12/02  15:11:09  doc
 * Patch 5 applied.
 * 
