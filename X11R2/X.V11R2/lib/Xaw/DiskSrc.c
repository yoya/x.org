#ifndef lint
static char rcsid[] = "$Header: DiskSrc.c,v 1.12 88/02/26 09:10:09 swick Exp $";
#endif lint
...
#include <X11/Text.h>
#include <X11/TextP.h>   /** included in all text subwindow files **/
...
int DiskReadText (src, pos, text, length)
  XtTextSource src;
