...
/* $Header:mpelhdwr.h 5.1$ */
/* $ACIS:mpelhdwr.h 5.1$ */
/* $Source: /vice/X11/src/server/ddx/ibm/mpel/RCS/mpelhdwr.h,v $ */

#ifndef lint
static char *rcsidmpelhdwr = "$Header:mpelhdwr.h 5.1$";
#endif
...
#define	MPEL_LOWDATA		((short *)0xf4c00000)
#define	MPEL_HIGHDATA		((short *)0xf4c3ffff)
...
#define	MPEL_LOWPROGRAM		((short *)0xf4d60000)
#define	MPEL_HIGHPROGRAM	((short *)0xf4d7ffff)
...
#define	MPEL_PCR		(*((CARD16 *)0xf0000948))
#define	MPEL_PSR		(*((CARD16 *)0xf000094a))
#define	MPEL_CA_PTR		(*((CARD32 *)0xf4c008e0))
#define MPEL_COMM_REQ		(*((CARD16 *)0xf4c00902))
#define MPEL_COMM_REASON	(*((CARD16 *)0xf4c00904))
#define MPEL_COMM_PARM_ADDR	((CARD16 *)0xf4c00954)
#define	MPEL_ATF_LOC_PTR	(*((CARD32 *)0xf4c00920))
#define MPEL_STATE_LIST_PTR	(*((CARD32 *)0xf4c00908))
#define MPEL_FIFO		(*((CARD16 *)0xf000094e))
#define MPEL_IPR		(*((CARD16 *)0xf0000940))
...
#define	MPEL_UCODE_ADDR		((short *)0xf4d60000)
#define	MPEL_UCODE_FILE		"/usr/lib/mpel/mcr1v001.bin"

#define	MPEL_CIRCLE_ADDR	((short *)0xf4c01e00)
#define	MPEL_CIRCLE_FILE	"/usr/lib/mpel/cirtab.dat"

#define	MPEL_SINE_ADDR		((short *)0xf4c02e00)
#define	MPEL_SINE_FILE		"/usr/lib/mpel/sintab.dat"

#define	MPEL_MARKER_LOC_ADDR	((short *)0xf4c07360)
#define	MPEL_MARKER_LOC_FILE	"/usr/lib/mpel/markid.dat"

#define	MPEL_HATCH_ADDR		((short *)0xf4c07ca0)
#define	MPEL_HATCH_FILE		"/usr/lib/mpel/hchtab.dat"

#define	MPEL_MARKER_FNT_ADDR	((short *)0xf4c04f00)
...
#define rtAddr(x) \
	( (short *)( ( ( (unsigned long )(x) & 0x03000000 ) >> 8 ) \
...
#define MPEL_PAT1		((short *)0xf4c10000)	/* 256 bytes */
#define MPEL_PAT2		((short *)0xf4c10100)	/* 256 bytes */
#define MPEL_PAT3		((short *)0xf4c10200)	/* 256 bytes */
#define MPEL_PAT4		((short *)0xf4c10300)	/* 256 bytes */
#define MPEL_CURSOR_SAVE	((short *)0xf4c10400)	/* 1024 bytes */
#define MPEL_COLOR_TABLE	((short *)0xf4c10800)	/* 1028 bytes */
#define MPEL_PAT_TABLE		((short *)0xf4c10c04)	/* 36 bytes */
#define MPEL_BLIT_STAGE		((short *)0xf4c11000)	/* 61440 bytes */
