...
******************************************************************/
/* $Header:addressing.c 1.3$ */
/* $ACIS:addressing.c 1.3$ */
/* $Source: /ibm/acis/usr/src/X11/server/ddx/ibm/vga/RCS/addressing.c,v $ */
...
#else
#define SINGLE_STORE \
    ( *( (VgaMemoryPtr) ( destination INCREMENT_OP ) ) = notZero )
#define SINGLE_SAVE
#endif
