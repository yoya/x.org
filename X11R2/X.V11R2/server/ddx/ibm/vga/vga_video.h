...
******************************************************************/
/* $Header:vga_video.h 1.4$ */
/* $ACIS:vga_video.h 1.4$ */
/* $Source: /ibm/acis/usr/src/X11/server/ddx/ibm/vga/RCS/vga_video.h,v $ */

#if !defined(lint) && !defined(LOCORE) && defined(RCS_HDRS)
static char *rcsidvga_video = "$Header:vga_video.h 1.4$";
#endif
 ...
 */
typedef unsigned volatile long int *VgaMemoryPtr ;
...
#else
extern int vga_screen_file ; /* Program GLOBAL File Descriptor for /dev/vga */
#define INTS_ON() /**/
#define INTS_OFF() /**/
#define VGABASE ( (volatile unsigned char *) \
	( 0xd00c0000 | ( SCREEN_ADDR & 0x0001ffff ) ) )
/* Hardware Registers */
#define ATTRIBUTE_ADDR	( (volatile unsigned long int *) 0xd00f03da )
#define ATTRIBUTE_REG	( (volatile unsigned long int *) 0xd00f03c0 )
#define DAC_ADDR 	( (volatile unsigned long int *) 0xd00f03c8 )
#define DAC_DATA 	( (volatile unsigned long int *) 0xd00f03c9 )
...
#define GO_BIOS_VIDEO_MODE( mode ) ioctl( vga_screen_file, BUFINITVGA, &mode )
#endif
