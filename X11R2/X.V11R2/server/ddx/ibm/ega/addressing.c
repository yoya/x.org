...
******************************************************************/
/* $Header:addressing.c 1.2$ */
/* $ACIS:addressing.c 1.2$ */
/* $Source: /ibm/acis/usr/src/X11/server/ddx/ibm/ega/RCS/addressing.c,v $ */

/*
 * "#included" into the BitBlit module
 * Generates Subroutines Containiing 
 * Unwound Optimized Loops
 */
...
#ifndef OLDHC
register int shift = 8 - backshift ;
#else
...
register int savebits ;
#ifndef OLDHC
register int backshift = 8 - shift ;
#else
...
#else
#define SINGLE_STORE \
    ( *( (EgaMemoryPtr) ( destination INCREMENT_OP ) ) = ~0 )
#define SINGLE_SAVE
#endif
