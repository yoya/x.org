...
******************************************************************/
/* $Header:egaSolid.c 1.2$ */
/* $ACIS:egaSolid.c 1.2$ */
/* $Source: /ibm/acis/usr/src/X11/server/ddx/ibm/ega/RCS/egaSolid.c,v $ */

#ifndef lint
static char *rcsid = "$Header:egaSolid.c 1.2$";
#endif
...
#ifndef OLDHC
register const unsigned char notZero = ~0 ;
#else
#define notZero ( ~0 )
#endif OLDHC
