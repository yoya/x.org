...
******************************************************************/
/* $Header:egaColorImg.c 1.2$ */
/* $ACIS:egaColorImg.c 1.2$ */
/* $Source: /ibm/acis/usr/src/X11/server/ddx/ibm/ega/RCS/egaColorImg.c,v $ */

#ifndef lint
static char *rcsid = "$Header:egaColorImg.c 1.2$";
#endif
