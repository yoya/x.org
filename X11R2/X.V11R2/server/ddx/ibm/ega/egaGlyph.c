...
******************************************************************/
/* $Header:egaGlyph.c 1.2$ */
/* $ACIS:egaGlyph.c 1.2$ */
/* $Source: /ibm/acis/usr/src/X11/server/ddx/ibm/ega/RCS/egaGlyph.c,v $ */

#ifndef lint
static char *rcsid = "$Header:egaGlyph.c 1.2$";
#endif
...
if ( shift = x & 07 ) { /* shift is amount to shift right */
	...
	for ( SourceRow = h,
		...
		/* Write Pattern */ /* Set The Bit Mask Reg */
