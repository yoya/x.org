...
/* $Header:aedpntarea.c 6.0$ */
/* $ACIS:aedpntarea.c 6.0$ */
/* $Source: /vice/X11/src/server/ddx/ibm/aed/RCS/aedpntarea.c,v $ */

#ifndef lint
static char *rcsid = "$Header:aedpntarea.c 6.0$";
#endif
    ...
    PixmapPtr pstipple;
{
    ...
    {
	bcopy(bits, vikint+vikoff, ( ( tilelen<<1 ) * tileHeight ) );
