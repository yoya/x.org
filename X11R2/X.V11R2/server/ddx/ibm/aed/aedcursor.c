...
******************************************************************/
/* $Header:aedcursor.c 6.0$ */
/* $ACIS:aedcursor.c 6.0$ */
/* $Source: /vice/X11/src/server/ddx/ibm/aed/RCS/aedcursor.c,v $ */

#ifndef lint
static char *rcsid = "$Header:aedcursor.c 6.0$";
#endif
    ...
    int		scrIndex;
{
    ...
    rtCursorX(scrIndex)=		(short *)0;
    rtCursorY(scrIndex)=		(short *)0;
    rtCursorBounds(scrIndex)->x1=	AED_SCREEN_WIDTH+65;
    rtCursorBounds(scrIndex)->y1=	AED_SCREEN_HEIGHT+65;
    rtCursorBounds(scrIndex)->x2=	AED_SCREEN_WIDTH+65;
    rtCursorBounds(scrIndex)->y2=	AED_SCREEN_HEIGHT+65;
    rtCursorShow(scrIndex)=		aedShowCursor;
    ...
    CursorPtr 	pCurs;
{
    ...
    rtCursorHotX(pScr->myNum)= 0;
    rtCursorHotY(pScr->myNum)= 0;

    rtCursorBounds(pScr->myNum)->x1=	AED_SCREEN_WIDTH;
    rtCursorBounds(pScr->myNum)->y1=	AED_SCREEN_HEIGHT;
    rtCursorBounds(pScr->myNum)->x2=	AED_SCREEN_WIDTH;
    rtCursorBounds(pScr->myNum)->y2=	AED_SCREEN_HEIGHT;
