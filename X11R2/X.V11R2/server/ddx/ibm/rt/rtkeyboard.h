...
/* $Header:rtkeyboard.h 6.0$ */
/* $ACIS:rtkeyboard.h 6.0$ */
/* $Source: /vice/X11/src/server/ddx/ibm/rt/RCS/rtkeyboard.h,v $ */

#if !defined(lint) && !defined(LOCORE)  && defined(RCS_HDRS)
static char *rcsidrtkeyboard = "$Header:rtkeyboard.h 6.0$";
#endif
